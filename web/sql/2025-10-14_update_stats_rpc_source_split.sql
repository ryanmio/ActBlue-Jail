-- Update get_stats RPC to categorize sources using refined logic
-- user_upload: message_type = 'unknown' OR (message_type = 'email' AND forwarder_email IS NOT NULL)
-- honeytrap (bot): message_type = 'sms' OR (message_type = 'email' AND forwarder_email IS NULL)
